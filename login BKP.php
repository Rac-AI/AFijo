...
<html class="lockscreen">
    <head>
        <meta charset="UTF-8">
        <title>Sistema Activo Fijo Informático </title>
    ...
    if (isset($_GET['codigo'])) {
        ...
        if ($temp_resg = $bd->mostrar_registros()) {
            ...
            $insertUser = "INSERT INTO `administrador` (`usuario` ,`pass` ,`nombre`  ,`correo` ,`nive_usua`, codigo_user, codigo_referr)
                                VALUES ('$temp_resg[usuario]', '$temp_resg[pass]', '$temp_resg[nombre]',  '$temp_resg[email]' , '$temp_resg[nive_usua]', '$codigo', '$temp_resg[codigo_referr]')";
        ...
        if(isset($_POST["btn1"])){
            ...
            if($btn=="Agregar"){
                ...
                if ($mostrar = $bd->mostrar_registros()) {
                    ...
                    $cabeceras .= "From: Rodrigo Alarcon Castro <ralarcon@grupocyg.cl>\r\n"; 
