...
$mipdf-> Ln (2);
$mipdf-> Cell(200,10,"LISTA DE INSTALACIONES",0,0,'C');

$mipdf -> Ln (15);
			
$mipdf -> SetFont('ARIAL','B', 9);
$mipdf -> SetFillColor(0, 191, 255);
$mipdf -> Cell(35,10,"INSTALACION",1,0,'C',true);
$mipdf -> SetFont('ARIAL','B', 9);
$mipdf -> SetFillColor(0, 191, 255);
$mipdf -> Cell(  90,10,"DESCRIPCION",1,0,'C',true);

		
//$mipdf -> Image("../webcam/fotos/$imagen",10,43,30,"JPG");
$mipdf -> Ln(10);
	
$sql="SELECT * FROM instalaciones ORDER BY descripcion";
...
while ($datos = $bd-> mostrar_registros($sql2)){
	...
	$mipdf -> SetFont('ARIAL','B', 9);
	$mipdf -> SetFillColor(1000,1000,255);
	$mipdf -> Cell( 90,10,$descripcion,1,1,'C',true);		
