...
$sql.="FROM celulares, marcas, compania, asignaciones, usuarios ";
$sql.="WHERE celulares.C_MARCA = marcas.codigo AND
...
if( $c_compania!="0" ){
	$sql.= "celulares.C_COMPANIA = '$c_compania' AND ";}
if( $numero!="" ){
	$sql.= "celulares.NUMERO = '$numero' AND ";}
if( $c_marca!="0" ){
	$sql.= "celulares.C_MARCA = '$c_marca' AND ";}
if( $modelo!="" ){
	$sql.="celulares.MODELO = '$modelo' AND ";}
if( $t_plan!="0" ){
	$sql.= "celulares.T_PLAN = '$t_plan' AND ";}
if( $estado_linea!="0" ){
	$sql.= "celulares.ESTADO_LINEA = '$estado_linea' AND ";}
if( $estado_equipo!="0" ){
	$sql.= "celulares.ESTADO_EQUIPO = '$estado_equipo' AND ";}
if( $id_usuario!="0" ){
	$sql.= "asignaciones.id_usuario = '$id_usuario' AND ";}	
