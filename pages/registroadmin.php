                                ...
                                <form role="form"  name="fe" action="?mod=registroadmin&nuevo=nuevo" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input onkeypress="return caracteres(event)" onblur="this.value=this.value.toUpperCase();" type="text" required type="tex" name="nombre" class="form-control" value="<?php echo $var_nombre ?>" id="exampleInputEmail1" placeholder="Intoducir el Nombre">
                                            <label for="exampleInputFile">Apellido</label>
                                            <input onkeypress="return caracteres(event)" onblur="this.value=this.value.toUpperCase();" required type="tex" name="apellido" class="form-control" value="<?php echo $var_apellido ?>" id="exampleInputEmail1" placeholder="Apellido">
                                            <label for="exampleInputFile">Usuario</label>
                                            <input required type="tex" name="usuario" class="form-control" value="<?php echo $var_usuario ?>" id="exampleInputEmail1" placeholder="Usuario">
                                            <label for="exampleInputFile">Clave</label>
                                            <input   required type="password" name="pw" class="form-control" value="<?php echo $var_clave ?>" id="exampleInputEmail1" placeholder="Contraseña">
                                            <label for="exampleInputFile">Correo</label>
                                            <input  required type="email" name="correo" class="form-control" value="<?php echo $var_correo ?>"  placeholder="Correo">
...
$bd->consulta($sql22);
     ...
     $consulta="SELECT usuario, nombre, apellido, correo, nive_usua, pass FROM administrador where id='$x1'";
     $bd->consulta($consulta);
     while ($fila=$bd->mostrar_registros()) {
                                        ...
                                        <div class="form-group">
                                           ...
                                           <label for="exampleInputFile">Nivel De Usuario</label>
                                                <select  for="exampleInputEmail" class="form-control" name='nivel'>
													...
													?>
														<option value="1">Administrador</option>
														<option value="2" selected>Usuario Invitado</option>
													<?php }
													?>
												</select>
                                        </div>
