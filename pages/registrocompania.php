...
if (isset($_GET['nuevo'])) { 
	if (isset($_POST['lugarguardar'])) {
		...
		$sql="select * from `compania` WHERE codigo = '$codigo'";
		$cs=$bd->consulta($sql);
		...
		if($bd->numeroFilas($cs)!=0){
			...
			echo '<div class="alert alert-danger alert-dismissable">
                                        ...
                                        <b>Alerta no se registro esta compania </b> Ya Existe... ';
            echo '   </div>';
		}else{
			$sql = "INSERT INTO `compania` (`codigo`, `descripcion`) VALUES ('$codigo', '$descripcion')";
            $cs=$bd->consulta($sql);  
...
?>
 ...
 <div class="col-md-10">
    ...
    <div class="box box-primary">
        ...
        <!-- form start -->
        <form role="form"  name="fe" action="?mod=registrocompania&nuevo=nuevo" method="post">
            <div class="box-body">
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                $consulta="SELECT codigo, descripcion FROM compania ORDER BY descripcion ";
                                ...
                                while ($fila=$bd->mostrar_registros()) {
									...
									echo "
										<a  href=?mod=registrocompania&editar&codigo=".$fila["codigo"]."><img src='./img/editar.png' width='25' alt='Edicion' title='EDITAR LOS DATOS DE ".$fila["descripcion"]."'></a> 
										<a   href=?mod=registrocompania&eliminar&codigo=".$fila["codigo"]."><img src='./img/elimina.png'  width='25' alt='Edicion' title='ELIMINAR A   ".$fila["descripcion"]."'></a>";}
									echo "</center></td></tr>";
                            ?>                                            
                        </tbody>
                        <tfoot>
		...
		<div class="col-md-3">
			<div class="box">
                <div class="box-header">
					<center>
						<div class="box-header">
                            <h3> <center>Imprimir Lista de Compañias</a></center></h3>                                    
                        </div>
                        <a target='_blank'  href=./pdf/listacompania.php><img src='./img/impresora.png'  width='50' alt='Edicion' title='Imprimir lista de Compañias'></a>
                    </center>
                </div>
            </div>
        </div>
	...
	{ 
        ...
        if (isset($_POST['editar'])) {
        ...
        else
           {
				...
				echo "Compañia: '$descripcion', codigo='$x1'";
                echo '   </div>';
			}
   
	}
                                
    $consulta="SELECT codigo, descripcion FROM compania where codigo='$x1'";
...
?>
    <div class="col-md-10">
        ...
        <div class="box box-primary">
            ...
            <?php  echo '  <form role="form"  name="fe" action="?mod=registrocompania&editar=editar&codigo='.$x1.'" method="post">';?>
            <div class="box-body">
                <div class="form-group">
...
{ 
    ...
    if (isset($_POST['eliminar'])) 
	{
        ...
        else
        {
			...
			// para poder eliminar
			$sql2="SELECT * FROM `celulares` WHERE c_compania = '$x1'";
			
			$cs=$bd->consulta($sql2);
			if($bd->numeroFilas($cs)==0){
				$sql="delete from compania where codigo='$x1' ";
				$bd->consulta($sql);
				...
				echo '<div class="alert alert-danger alert-dismissable">
											<i class="fa fa-check"></i>
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
											<b>Alerta esta compania no se puede eliminar </b> hay celulares asignados... ';
				echo '   </div>';					
			}							
        }
	}
...
?>
		<div class="col-md-10">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Eliminar Compañia</h3>
                </div>
                <?php  echo '  <form role="form"  name="fe" action="?mod=registrocompania&eliminar=eliminar&codigo='.$x1.'" method="post">';?>
                <div class="box-body">
                    <div class="form-group">
                        <label for="exampleInputFile">Descripcion</label>
