...
if (isset($_GET['nuevo'])) { 
	if (isset($_POST['lugarguardar'])) {
		...
		$sql="select * from `marcas` WHERE codigo = '$codigo'";
		$cs=$bd->consulta($sql);
		...
		if($bd->numeroFilas($cs)!=0){
			...
			echo '<div class="alert alert-danger alert-dismissable">
                                        ...
                                        <b>Alerta no se registro esta marca </b> Ya Existe... ';
            echo '   </div>';
		}else{
			$sql = "INSERT INTO `marcas` (`codigo`, `descripcion`) VALUES ('$codigo', '$descripcion')";
            $cs=$bd->consulta($sql);  
...
?>
 ...
 <div class="col-md-10">
    ...
    <div class="box box-primary">
        ...
        <!-- form start -->
        <form role="form"  name="fe" action="?mod=registromarcas&nuevo=nuevo" method="post">
            <div class="box-body">
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                $consulta="SELECT codigo, descripcion FROM marcas ORDER BY descripcion ";
                                ...
                                while ($fila=$bd->mostrar_registros()) {
									...
									echo "
										<a  href=?mod=registromarcas&editar&codigo=".$fila["codigo"]."><img src='./img/editar.png' width='25' alt='Edicion' title='EDITAR LOS DATOS DE ".$fila["descripcion"]."'></a> 
										<a   href=?mod=registromarcas&eliminar&codigo=".$fila["codigo"]."><img src='./img/elimina.png'  width='25' alt='Edicion' title='ELIMINAR A   ".$fila["descripcion"]."'></a>";}
									echo "</center></td></tr>";
                            ?>                                            
                        </tbody>
                        <tfoot>
		...
		<div class="col-md-3">
			<div class="box">
                <div class="box-header">
					<center>
						<div class="box-header">
                            <h3> <center>Imprimir Lista Marcas</a></center></h3>                                    
                        </div>
                        <a target='_blank'  href=./pdf/listamarcas.php><img src='./img/impresora.png'  width='50' alt='Edicion' title='Imprimir lista Marcas'></a>
                    </center>
                </div>
            </div>
        </div>
	...
	{ 
        ...
        if (isset($_POST['editar'])) {
        ...
        else
           {
				...
				echo "Marca: '$descripcion', codigo='$x1'";
                echo '   </div>';
			}
   
	}
                                
    $consulta="SELECT codigo, descripcion FROM marcas where codigo='$x1'";
...
?>
    <div class="col-md-10">
        ...
        <div class="box box-primary">
            ...
            <?php  echo '  <form role="form"  name="fe" action="?mod=registromarcas&editar=editar&codigo='.$x1.'" method="post">';?>
            <div class="box-body">
                <div class="form-group">
...
{ 
    ...
    if (isset($_POST['eliminar'])) 
	{
        ...
        else
        {
			...
			// Validar que NO TENGA asignado un computador
			// para poder eliminar
			$sql2="SELECT * FROM `computadores` WHERE c_marca = '$x1'";
			$cs=$bd->consulta($sql2);
			if($bd->numeroFilas($cs)==0){

				// Validar que NO TENGA asignado un celular
				// para poder eliminar
				$sql2="SELECT * FROM `celulares` WHERE c_marca = '$x1'";
				$cs=$bd->consulta($sql2);
				if($bd->numeroFilas($cs)==0){

					$sql="delete from marcas where codigo='$x1' ";
					$bd->consulta($sql);
					//echo "Datos Guardados Correctamente";
					echo '<div class="alert alert-success alert-dismissable">
							<i class="fa fa-check"></i>
					...
					echo '<div class="alert alert-danger alert-dismissable">
												<i class="fa fa-check"></i>
												<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
												<b>Alerta esta marca no se puede eliminar </b> hay celulares asignados... ';
					echo '   </div>';					
				}	
				...
				echo '<div class="alert alert-danger alert-dismissable">
											<i class="fa fa-check"></i>
											<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
											<b>Alerta esta marca no se puede eliminar </b> hay computadores asignados... ';
				echo '   </div>';					
			}							
...
?>
		<div class="col-md-10">
            ...
            <div class="box box-primary">
                ...
                <?php  echo '  <form role="form"  name="fe" action="?mod=registromarcas&eliminar=eliminar&codigo='.$x1.'" method="post">';?>
                <div class="box-body">
                    <div class="form-group">
                        <label for="exampleInputFile">Descripcion</label>
